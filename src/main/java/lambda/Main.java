...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        Supplier<Double> lazyValue = () -> {
            return (100500+2000)*234.0;
        };

        Double valueSquared = squareLazy(lazyValue);
        System.out.println("Supplier --> squareLazy: ");
        System.out.println(valueSquared);

        //Operator
        UnaryOperator<Apple> changeCountry =  a -> {
            a.setCountry(a.getCountry().toLowerCase());
            return a;
        };

        apples.replaceAll(changeCountry);
